 ...
 * @Description: 导航栏组件
 * @Author: Bhb
 * @Date: 2022-03-30 17:50:09
 * @LastEditTime: 2022-04-02 16:25:40
 * @LastEditors: Bhb
 * @FilePath: \src\views\NavBar\index.vue
-->
<template lang="">
  <div>
    <nav>
...
export default {
  ...
  data() {
    return {
      inputFocus:true,
      avatarUrl:'http://s4.music.126.net/style/web2/img/default/default_avatar.jpg?param=60y60'
    }
  },
  methods:{
    showUserProfileMenu(){
